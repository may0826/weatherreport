...
public class WeatherActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                decorView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
                        | View.SYSTEM_UI_FLAG_LAYOUT_STABLE);//调用这个方法来改变系统UI的显示
    ...
    public void requestWeather(final String cityName) {
        String weatherUrl = "https://free-api.heweather.com/v5/weather?city=" + cityName + "&key=a0187789a4424bc89254728acd4a08ed";
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {//通过此方法向地址发出请求，服务器会将相应的数据以JSON的格式返回
            @Override
